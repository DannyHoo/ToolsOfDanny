package com.danny.tools.spider;
 ...
 * @Description:
 * http://blog.csdn.net/u013018721/article/details/36929579
 * @Company: lxjr.com
 * @Created on 2017-06-16 09:57:25
 */
public class EmailSpider {
    public static void main(String[] args) throws Exception {// 本程序内部异常过多为了简便，不一Try，直接抛给虚拟机
        ...
        System.out.println("");
        System.out.println("--请输入正确的网址如http：//www.baidu.com--http://blog.sina.com.cn/s/blog_515617e60101e151.html");
        Scanner input = new Scanner(System.in);// 实例化键盘输入类

        //String webaddress = input.next();// 创建输入对象
        String webaddress = "http://blog.sina.com.cn/s/blog_515617e60101e151.html";// 创建输入对象
        File file = new File("/Users/dannyhoo/Desktop/" + File.separator + "爬虫邮箱统计文本.txt");// 实例化文件类对象
